...
GEMINI_API_KEY = "AIzaSyBm7weSF--71qb5AI5s8A8HE-JwDSww5Lo"  # Replace with your valid API key
...
st.markdown(
    ...
    <footer style="text-align:center;">
        <p>Powered by <strong>Google Gemini API</strong> | ©️ Rajpal | Built with ❤️ using Streamlit</p>
    </footer>
    """,
    unsafe_allow_html=True,
)
